...
{
    if (type == 0) {
        ui->labIcoMain->setStyleSheet("border-image: url(:/res/images/info.png);");
        ui->btnCancel->setVisible(false);
        ui->lab_Title->setText("Info");
    } else if (type == 1) {
        ui->labIcoMain->setStyleSheet("border-image: url(:/res/images/question.png);");
        ui->lab_Title->setText("Question");
    } else if (type == 2) {
        ui->labIcoMain->setStyleSheet("border-image: url(:/res/images/error.png);");
        ui->btnCancel->setVisible(false);
